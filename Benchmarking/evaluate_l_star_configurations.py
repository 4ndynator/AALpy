...
closedness_types = ['suffix', 'prefix', 'suffix_all', 'prefix_all']
...
tc = 0
num_exp = len(test_models) * len(is_suffix_closed) * len(closing_strategies) * len(closedness_types) * num_repeats
