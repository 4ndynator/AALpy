...
class Node:
    __slots__ = ['output', 'children', 'parent', 'frequency', 'input_frequencies']
    ...
    def get_child(self, inp, out):
        ...
        """
        return next((child for child in self.children[inp] if child.output == out or child.output is None), None)
