...
from aalpy.automata import DfaState, Dfa, MealyState, MealyMachine, MooreState, MooreMachine, OnfsmState
...
class NonDetClassificationTree:
    ...
    def gen_hypothesis(self):
        ...
        for node in self.leaf_nodes.values():
            ...
            new_state = OnfsmState(state_id=f's{state_counter}')
